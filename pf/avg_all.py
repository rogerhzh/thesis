...
ax_ipc = plt.subplot(2,3,2)
ax_ws = plt.subplot(2,3,3)
ax_ms = plt.subplot(2,3,4)
ax_fs = plt.subplot(2,3,5)
...
target_miss = open("./avg_miss.txt")
target_ipc = open("./avg_ipc.txt")
target_ws = open("./avg_ws.txt")
target_ms = open("./avg_ms.txt")
target_fs = open("./avg_fs.txt")
...
ax.set_xlabel('Group ID',size = 25)
#newax.set_xlabel('The number of benchmarks')
ax.set_ylabel('Average MPKI',size = 25)
ax.set_xticks(xticks_2)
ax.set_xticklabels(xlbls_2,size = 20)
#ax.set_xticks(xticks_minor,minor = True)
...
ax_ipc.axis([0,5,4,25])
#newax_ipc.axis([0,25,4,25])
ax_ipc.set_xlabel('Group ID',size = 25)
#newax_ipc.set_xlabel('The number of benchmarks')
ax_ipc.set_ylabel('IPC',size = 25)
#ax_ipc.yaxis.set_major_locator(yloc)
ax_ipc.set_xticks(xticks_2)
ax_ipc.set_xticklabels(xlbls_2,size = 20)
#ax_ipc.set_xticks(xticks_minor,minor = True)
#ax_ipc.grid(b=True,which = 'minor',linestyle ='--')
...
ax_ws.axis([0,5,1,1.9])
#newax_ws.axis([0,25,1,1.9])
ax_ws.set_xlabel('Group ID',size = 25)
#newax_ws.set_xlabel('The number of benchmarks')
ax_ws.set_ylabel('Average Weighted Slowdown',size = 25)
ax_ws.set_xticks(xticks_2)
ax_ws.set_xticklabels(xlbls_2,size = 20)
#ax_ws.set_xticks(xticks_minor,minor = True)
#ax_ws.grid(b=True,which = 'minor',linestyle ='--')
...
ax_ms.axis([0,5,1,4.5])
#newax_ms.axis([0,25,1,4.5])
ax_ms.set_xlabel('Group ID',size = 25)
#newax_ms.set_xlabel('The number of benchmarks')
ax_ms.set_ylabel('Max Weighted Slowdown',size = 25)
ax_ms.set_xticks(xticks_2)
ax_ms.set_xticklabels(xlbls_2,size = 20)
#ax_ms.set_xticks(xticks_minor,minor = True)
#ax_ms.grid(b=True,which = 'minor',linestyle ='--')
...
ax_fs.axis([0,5,1,1.9])
#newax_fs.axis([0,25,1,1.9])
ax_fs.set_xlabel('Group ID',size = 25)
#newax_fs.set_xlabel('The number of benchmarks')
ax_fs.set_ylabel('Fair Weighted Slowdown',size = 25)
ax_fs.set_xticks(xticks_2)
ax_fs.set_xticklabels(xlbls_2,size = 20)
#ax_fs.set_xticks(xticks_minor,minor = True)
#ax_fs.grid(b=True,which = 'minor',linestyle ='--')
