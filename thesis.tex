...
\pkuthssinfo{
	...
	ctitle = {CAPS：基于部分共享的高速缓存分配优化}, etitle = {CAPS: Cache Allocation with Partial Sharing},
	cauthor = {黄子翚},
	eauthor = {Huang Zihui},
	...
	ckeywords = {多核，高速缓存分配技术，部分共享，优化}, ekeywords = {Multicore, CAT, Partial-sharing, Optimization}
}
...
\begin{document}
	...
	\include{chap/prediction}
	\include{chap/allocation}
